...
public:
	...
	virtual void					BeforeWorldRender(); //--#SM+#-- +SecondVP+ Âuçuâaaony ia?aä ía÷aëîi ?aíäa?a ie?a e iîno-ýôôaeoîâ
	virtual void					AfterWorldRender();  //--#SM+#-- +SecondVP+ Âuçuâaaony iînëa ?aíäa?a ie?a e ia?aä UI
